...
public class HTSConnection extends Thread {
    ...
    public void open(String hostname, int port) {
        ...
        try {
            ...
            System.err.println(TAG+" Can't open connection "+ex);
    ...
    public void sendMessage(HTSMessage message, HTSResponseHandler listener) {
        ...
        try {
            ...
            System.err.println(TAG+" Can't transmit message "+ex);
    ...
    public void close() {
        ...
        try {
            ...
            System.err.println(TAG+" can't close connection "+ex);
        } finally {
            lock.unlock();
        }
    }
    ...
    public void run() {
        while (running) {
            ...
            try {
            	...
            	ex.printStackTrace();
                System.err.println(TAG+" Can't read message "+ex);
                listener.onError(ex);
                running = false;
            } finally {
                lock.unlock();
